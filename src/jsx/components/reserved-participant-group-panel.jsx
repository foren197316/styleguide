var ReservedParticipantGroupPanels = React.createClass({
  getInitialState: function() {
    return {
      reservedParticipantGroups: null
    };
  },
  ...
  componentDidMount: function() {
    $.get(this.props.source, function(data) {
      if (this.isMounted()) {
        this.setState({
          reservedParticipantGroups: data.reserved_participant_groups
        });
      }
    }.bind(this));
  },
  ...
  render: function() {
    if (this.isMounted()) {
      var employerId = this.props.employerId,
          reservedParticipantGroupPanels = this.state.reservedParticipantGroups.map(function (reservedParticipantGroup) {
        return (
          <ReservedParticipantGroupPanel key={reservedParticipantGroup.id} data={reservedParticipantGroup} employerId={employerId} />
        );
      });
...
var ReservedParticipantGroupPanel = React.createClass({
  getInitialState: function() {
